...
test:
    {{gerbil}} test t/build-script-command-test.ss t/package-build-contract-test.ss t/package-native-declaration-test.ss t/build-api-source-bootstrap-test.ss t/build-api-startup-scenario-test.ss t/provider-owned-schema-registry-test.ss t/exact-source-projection-test.ss t/projection-batch-test.ss t/projection-batch-scenario-test.ss t/language-projection-test.ss t/testing-extension-test.ss t/testing-native-batch-scenario-test.ss t/project-policy-test.ss
