...
(import :std/test
        ...
        "./agent-poo-hot-loop-runtime-debug-test"
        "./agent-poo-hot-loop-runtime-compact-test")
...
(def agent-poo-hot-loop-runtime-policy-test
  (test-suite "gerbil scheme harness agent POO hot loop runtime policy"
    (test-case "agent-poo-hot-loop-runtime-debug-policy-test"
      (check (test-result-ok? (test-suite! agent-poo-hot-loop-runtime-debug-policy-test)) => #t))
    (test-case "agent-poo-hot-loop-runtime-compact-policy-test"
      (check (test-result-ok? (test-suite! agent-poo-hot-loop-runtime-compact-policy-test)) => #t))))
