...
(def (write-downstream-poo-agent-positive-project root)
  (let* ((src (string-append root "/src"))
    ...
    (write-text
     ...
     "#!/usr/bin/env gxi\n;;; -*- Gerbil -*-\n;;; Build boundary:\n;;; - ASP Building API owns declaration; std/make owns execution.\n(import (only-in :std/build-script defbuild-script) :asp-gerbil-scheme/building-api)\n(asp-gerbil-scheme-package-spec! (sample-orders-package-spec @ asp-gerbil-scheme-library-package-prototype) (spec spec) (role 'library) (modules '(\"src/orders/core.ss\" \"src/orders/methods.ss\")))\n(defbuild-script (spec))\n")
    (write-text (string-append owner "/core.ss")
