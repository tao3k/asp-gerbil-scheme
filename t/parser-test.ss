...
(def parser-test
  (test-suite "gerbil scheme harness parser"
    (test-case "parser-test-part-1"
      (check (test-result-ok? (test-suite! parser-test-part-1)) => #t))
    (test-case "parser-test-part-2"
      (check (test-result-ok? (test-suite! parser-test-part-2)) => #t))
    (test-case "parser-test-part-3"
      (check (test-result-ok? (test-suite! parser-test-part-3)) => #t))
    (test-case "parser-test-part-4"
      (check (test-result-ok? (test-suite! parser-test-part-4)) => #t))
    (test-case "parser-test-part-5"
      (check (test-result-ok? (test-suite! parser-test-part-5)) => #t))
    (test-case "parser-test-part-6"
      (check (test-result-ok? (test-suite! parser-test-part-6)) => #t))
    (test-case "parser-test-part-7"
      (check (test-result-ok? (test-suite! parser-test-part-7)) => #t))
    (test-case "parser-test-part-8"
      (check (test-result-ok? (test-suite! parser-test-part-8)) => #t))))
