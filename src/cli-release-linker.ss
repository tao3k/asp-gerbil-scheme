...
(import (only-in :gslph/src/commands/search-structural
        ...
        (only-in :gslph/src/commands/projection-batch projection-batch-main)
        (only-in :gslph/src/commands/project-resolution project-resolution-main)
...
(def (release-command-main descriptor)
  (case (provider-command-descriptor-static-main descriptor)
    ((project-resolution-main) project-resolution-main)
    ((search-main) search-main)
    ((query-main) query-main)
    ((projection-main) projection-main)
    ((projection-batch-main) projection-batch-main)
    ((fmt-main) fmt-main)
